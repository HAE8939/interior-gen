...
export function FormShell() {
  ...
  return (
    <div className="space-y-4">
      {/* ============ TIER 1 · 必填 ============ */}
      <Section title="基础选项" subtitle="必填·一眼可见" badge="必填" defaultOpen>
      ...
      {/* ============ TIER 2 · 推荐 ============ */}
      <Section title="进阶选项" subtitle="推荐·建议补充以获得更精准的输出" badge="推荐" defaultOpen>
      ...
      {/* ============ Always visible · 自由输入 ============ */}
      <Section title="自由输入" subtitle="任何补充需求，LLM 会翻译并融入" badge="补充" defaultOpen>
        <FreeTextArea />
      </Section>
    </div>
  );
